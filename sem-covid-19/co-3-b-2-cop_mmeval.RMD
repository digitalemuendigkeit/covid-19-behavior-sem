...
write_excel_csv(refevalmm %>% mutate(across(3:7,  round, 2)), "paper/mmevalref-co-3-b-2-cop.csv",delim = ";")
write_excel_csv(boothtmt %>% mutate(across(3:4,  round, 2)), "paper/htmt-co-3-b-2-cop.csv",delim = ";")
write_excel_csv(forevalmm %>% mutate(across(c(3:8, 10:12),  round, 2)), "paper/mmevalfor-co-3-b-2-cop.csv",delim = ";")
write_excel_csv(forhocevalmm %>% mutate(across(c(3:6, 8:10),  round, 2)), "paper/mmevalhoc-co-3-b-2-cop.csv",delim = ";")
```
