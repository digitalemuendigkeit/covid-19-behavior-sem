---
title: "COVID-19 Model Iteration 3-b-2 Structural Model Evaluation"
output: 
...
# Structural Model Only plot

This is a path model showing only the structural model components.

```{r plot sm model, echo=FALSE, layout = "l-page"}
...
However, for the COBI1, COBI2, CORB7, CORB8 and CCORB9 the difference in prediction errors between PLS and and naive LM is only marginal.
...
write_excel_csv(sumsm %>% mutate(across(c(3:4,6:9),  round, 2)), "smeval-co-3-b-2.csv",delim = ";")
plot(bootmodel)
