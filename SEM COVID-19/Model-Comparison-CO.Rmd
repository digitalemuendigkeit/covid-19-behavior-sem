...
In terms of in-sample predictive power, the COVID-19 3-a-1 model performs best (mean of R²adj around 0.4).
When it comes to the in-sample predictive power concerning Behavioral Intention, the COVID-19 3-b-2 model shows the best results (R²adj around 0.7).
