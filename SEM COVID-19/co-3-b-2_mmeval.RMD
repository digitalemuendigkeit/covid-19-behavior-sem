---
title: "COVID-19 Model Iteration 3-b-2 Measurement Model Evaluation"
output: 
...
```{r for-eval redundancy analysis,, echo = FALSE, include=FALSE}
all_reduds <- list(model = list(rapre, raprc, radn, rabi), 
...
# reflective mm
write_excel_csv(refevalmm %>% mutate(across(3:7,  round, 2)), "mmevalref-co-3-b-2.csv",delim = ";")
#htmt details
write_excel_csv(boothtmt %>% mutate(across(3:4,  round, 2)), "htmt-co-3-b-2.csv",delim = ";")
# formative mm
write_excel_csv(forevalmm %>% mutate(across(c(3:8, 10:12),  round, 2)), "mmevalfor-co-3-b-2.csv",delim = ";")
# formative hoc mm
write_excel_csv(forhocevalmm %>% mutate(across(c(3:6, 8:10),  round, 2)), "mmevalhoc-co-3-b-2.csv",delim = ";")
```
