...
resettest(lmtb2)
```
Using p = 0.05 as a threshold, there are potential nonlinear effects in the partial regression equations for the influence of Response Beliefs (original: p  0.004, proxy: p = 0.006), Threat Beliefs (original and proxy: p < 0.001), and Subjective Norm (original: p = 0.03, proxy: p = 0.04) on Behavioral Intention.
The same is potentially true for the effects of Distrusting Beliefs (original: p = 0.02, proxy: p = 0.1) and Knowledge (p = 0.006) on Response Beliefs, an for the effects of Distrusting Beliefs (original: p  0.003, proxy: p = 0.003) and Knowledge (p = 0.02) on Threat Beliefs.
...
```{r bi1 alt nonlinear estimate, echo = FALSE}
...
bi3compdf <- data.frame(
  Model = c("Original Model", "Proxy Model", "Quadratic Model Orthogonal", "Quadratic Model Product-Indicator"),
  `f²` = c(
    summo$fSquare["Threat Beliefs", "Behavioral Intention"],
    sumprmo$fSquare["Threat Beliefs", "Behavioral Intention"],
    (mobi3altort$rSquared[1,"Behavioral Intention"]-mobi3altex$rSquared[1,"Behavioral Intention"])/(1-mobi3altort$rSquared[1,"Behavioral Intention"]),
    (mobi3altpi$rSquared[1,"Behavioral Intention"]-mobi3altex$rSquared[1,"Behavioral Intention"])/(1-mobi3altpi$rSquared[1,"Behavioral Intention"])
  ),
  `t-value` = c(sumbomo$bootstrapped_paths[8,4], sumboprmo$bootstrapped_paths[8,4], sumbomobi3altort$bootstrapped_paths[8,4], sumbomobi3altpi$bootstrapped_paths[8,4])
)
bi3compdf
```
...
rb1compdf <- data.frame(
  ...
  `f²` = c(
    ...
    (morb1altort$rSquared[1,"Behavioral Intention"]-morb1altex$rSquared[1,"Behavioral Intention"])/(1-morb1altort$rSquared[1,"Behavioral Intention"]),
    (morb1altpi$rSquared[1,"Behavioral Intention"]-morb1altex$rSquared[1,"Behavioral Intention"])/(1-morb1altpi$rSquared[1,"Behavioral Intention"])
  ),
  `t-value` = c(sumbomo$bootstrapped_paths[1,4], sumboprmo$bootstrapped_paths[1,4], sumbomorb1altort$bootstrapped_paths[1,4], sumbomorb1altpi$bootstrapped_paths[1,4])
)
rb1compdf
```
...
Neither of those alternate approaches shows a significant effect of a Distrusting Beliefs quadratic term.
This points to a linear effect of Distrusting Beliefs on Response Beliefs.

##Knowledge on Response Beliefs
...
```
```{r rb2 alt nonlinear assess}
# Assess impact using f² and significance
rb2compdf <- data.frame(
  Model = c("Original Model", "Proxy Model", "Quadratic Model"),
  `f²` = c(
    summo$fSquare["Threat Beliefs", "Behavioral Intention"],
    sumprmo$fSquare["Threat Beliefs", "Behavioral Intention"],
    (morb2alt$rSquared[1,"Behavioral Intention"]-morb2altex$rSquared[1,"Behavioral Intention"])/(1-morb2alt$rSquared[1,"Behavioral Intention"])
  ),
  `t-value` = c(sumbomo$bootstrapped_paths[3,4], sumboprmo$bootstrapped_paths[3,4], sumbomorb2alt$bootstrapped_paths[3,4])
)
rb2compdf
```
