...
# To improve internal consistency reliability of Personal Norm, COPN2 should be deleted. Because of a lack of convergent validity, the formative Perceived Self-Efficacy construct should be replaced by a single-item reflective Perceived Self-Efficacy construct.
mm <- constructs(
...
# saveRDS(rapse, "SEM COVID-19/Models/rapse-co-2.RDS")
