...
Apart from that, there is no discernible effect of Knowledge on Response Beliefs, or of Threat Beliefs on Behavioral Intention.
...
The effect of Perceived Response Efficacy on Behavioral Intention is medium at 0.21.
...
```
The path coefficients of many of the relationships including lower-order constructs are insignificant.
All relationships between (higher-order) constructs and other (higher-order) constructs show significant path coefficients.
Some are very small, especially the path coefficient of Knowledge to Response Beliefs (0.09)
...
# Results summary
All structural paths can be retained.
