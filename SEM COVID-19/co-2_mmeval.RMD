---
title: "COVID-19 Iteration 2 Measurement Model Evaluation"
...
# rapse <- readRDS("Models/rapse-co-2.RDS")
...
All indicators and constructs show sufficient convergent validity and internal consistency reliability. For Personal Moral Norm, composite reliability is still above 0.95, but as Cronbach's alpha and construct reliability are below 0.9 and composite reliability tends to overestimation, all indicators are retained.
However, with the change of Perceived Self-Efficacy to single-indicator reflective indicator, problems with discriminant validity appear. Specifically, there seems to be overlap between Response Beliefs and Personal norm, with the upper 95 % bootstrap confidence interval bound being 1.007. How should we proceed?
