...
# The path from Knowledge to Perceived Response Costs is not significant and the effect size is negligible.
# Therefore, this path can be removed.
...
# saveRDS(model, "SEM COVID-19/Models/model-co-3-b-2.RDS")
# model <- readRDS("SEM COVID-19/Models/model-co-3-b-2.RDS")
# plot(model)
# bootmodel <- bootstrap_model(model, nboot = 5000)
# saveRDS(bootmodel, "SEM COVID-19/Models/model-boot-co-3-b-2.RDS")
bootmodel <- readRDS("SEM COVID-19/Models/model-boot-co-3-b-2.RDS")
# bootfsmodel <- bootstrap_model(model$first_stage_model, nboot = 5000)
# saveRDS(bootfsmodel, "SEM COVID-19/Models/model-fs-boot-co-3-b-2.RDS")
...
saveRDS(rapre, "SEM COVID-19/Models/rapre-co-3-b-2.RDS")
...
saveRDS(raprc, "SEM COVID-19/Models/raprc-co-3-b-2.RDS")
...
saveRDS(radn, "SEM COVID-19/Models/radn-co-3-b-2.RDS")
...
saveRDS(rabi, "SEM COVID-19/Models/rabi-co-3-b-2.RDS")
...
saveRDS(proxymodel, "SEM COVID-19/Models/model-proxy-co-3-b-2.RDS")
