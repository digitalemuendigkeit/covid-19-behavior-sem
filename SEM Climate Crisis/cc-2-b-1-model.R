...
# Behavior: Heating, i.e. CCBI2, CCRB2, CCRB5, CCRB8
...
# saveRDS(model, "SEM Climate Crisis/Models/model-cc-2-b.RDS")
model <- readRDS("SEM Climate Crisis/Models/model-cc-2-b.RDS")
plot(model)
# bootmodel <- bootstrap_model(model, nboot = 5000)
# saveRDS(bootmodel, "SEM Climate Crisis/Models/model-boot-cc-2-b.RDS")
bootmodel <- read_rds("SEM Climate Crisis/Models/model-boot-cc-2-b.RDS")
plot(bootmodel)
# bootfsmodel <-  bootstrap_model(model$first_stage_model, nboot = 5000)
# saveRDS(bootfsmodel, "SEM Climate Crisis/Models/model-fs-boot-cc-2-b.RDS")
...
saveRDS(radn, "SEM Climate Crisis/Models/radn-cc-2-b.RDS")
...
saveRDS(rain, "SEM Climate Crisis/Models/rain-cc-2-b.RDS")
