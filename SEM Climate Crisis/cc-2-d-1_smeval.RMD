...
For the Distrusting Beliefs lower-order constructs, Integrity has only negligible effects, Competence only on Perceived Severity, and Benevolence none on Perceived Response Costs and Perceived Severity.
None of the Threat or Response Beliefs lower-order constructs has a discernible effect on Behavioral Intention.
On a construct level, there seems to be no discernible effect of Threat Beliefs, Subjective Norm, or Personal Moral Norm on Behavioral Intention, or of Knowledge on Response Beliefs or any of its lower-order constructs.
...
```
As already hinted by a lack of effect size, neither Threat Beliefs nor Personal Moral Norm show a significant influence on Behavioral Intention as indicated by the path coefficients.
For Subjective Norm, the path from the higher-order construct is significant, but the path from the lower-order constructs is not.
The path from Knowledge to Response Beliefs and all its lower-order constructs is non-significant as well.
The paths from Integrity are non-significant ecept for the paths to Perceived Susceptibility, as are all paths from Competence to the Response Beliefs lower-order constructs.
...
# Results summary
The paths from Threat Beliefs and Personal Moral Norm, and Subjective Norm to Behavioral Intention are insignificant and the effect sizes are negligible.
