---
title: "Climate Crisis Model Iteration 2-a (Only Diet) Measurement Model Evaluation"
...
radn <- readRDS("Models/radn-cc-2-a.RDS")
rain <- readRDS("Models/rain-cc-2-a.RDS")
...
Two weights are insignificant on the basis of the bootstrap CI (CCDN1 and CCIN1), however, the loadings are large enough and significant.
...
The weight for Perceived Response Costs is non-significant, and the loading is not sufficiently large.
Therefore, it should be removed.
All other weights are significant and relevant.

## Results of the formative higher-order constructs evaluation
Perceived Response Costs has to be removed, otherwise the formative higher-order constructs can be retained as-is.
