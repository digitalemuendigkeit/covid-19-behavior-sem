---
title: "Climate Crisis Model Iteration 2-c-3 (Driving) Structural Model Evaluation"
...
In particular, there is no discernible effect of Benevolence or Competence on Perceived Self-Efficacy and Perceived Response Costs.
...
```
For the approximation model, only CBI3 is predicted better by the PLS model than by the linear model in terms of RMSE.
...
```
Benevolence has no significant influence on Perceived Response Costs, and Competence has no significant influence on Perceived Self-Efficacy.
...
Possibly, more precise results could be achieved by splitting up the Response Beliefs higher-order construct in its lower-order constructs.
