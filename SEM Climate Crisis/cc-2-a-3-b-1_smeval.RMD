---
title: "Climate Crisis Model Iteration 2-a-3-b-1 Structural Model Evaluation"
...
```
The in-sample predictive power for Perceived Response Efficacy is very weak, and the R² for Perceived Self-Efficacy is below even that threshold.
...
There is no discernible effect of Benevolence or Knowledge on either Perceived Self-Efficacy or Perceived Response Efficacy.
...
```
The model does only have very weak out-of-sample predictive power.
...
All other paths are significant and relevant.
...
# Results summary
Overall, the model is satisfactory, but in-sample as well as out-sample predictive power is low and effect sizes, with the exception of the effect of Distrusting Beliefs on Perceived Response Efficacy and the effect of Perceived Self-Efficacy on Behavioral Intention, are as well.
