---
title: "Climate Crisis Model Iteration 2-c-3-a-1 (Driving) Structural Model Evaluation"
...
In particular, there is no discernible effect of Benevolence on any of the descendent lower-order constructs or Competence on Perceived Self-Efficacy and Perceived Response Costs.
...
```
For the approximation model, no indicator is predicted better by the PLS model.
This indicates that the model lacks out-of-sample predictive power.
...
```
Benevolence and Competence gave no significant influence on either  Perceived Response Costs or Perceived Self-Efficacy.
...
# Results summary
The structural model satisfies quality criteria.
Possibly, more precise results could be achieved by splitting up the Response Beliefs higher-order construct in its lower-order constructs. (see cc-2-c-3-b-1)
