---
title: "Climate Crisis Model Iteration 2-d-2 (General) Measurement Model Evaluation"
...
radn <- readRDS("Models/radn-cc-2-d-2.RDS")
rain <- readRDS("Models/rain-cc-2-d-2.RDS")
...
```
There are no problematic HTMT bootstrap confidence intervals.
...
There are no issues with collinearity.
