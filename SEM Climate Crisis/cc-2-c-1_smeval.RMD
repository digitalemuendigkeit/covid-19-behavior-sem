...
```
As already hinted by a lack of effect size, neither Personal Moral Norm nor Subjective Norm show a significant influence on Behavioral Intention as indicated by the path coefficients, nor does Knowledge on Response Beliefs.
...
None of the Threat Beliefs lower-order constructs has a significant effect on Behavioral Intention, but Threat Beliefs does.
