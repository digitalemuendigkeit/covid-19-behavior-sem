---
title: "Climate Crisis Model Iteration 2-c-3-b-2 (Driving) Structural Model Evaluation"
...
Other than that, R² for Perceived Response Efficacy is between 0.1 and 0.25, indicating very weak in-sample predictive power.
...
In particular, there is no discernible effect of Benevolence  or Competence on Perceived Self-Efficacy.
...
```
Competence has no significant influence on Perceived Self-Efficacy.
...
# Results summary
The model meets quality criteria and can be retained as-is.
However, predictivity is rather low.
