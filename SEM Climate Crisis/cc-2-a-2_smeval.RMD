---
title: "Climate Crisis Model Iteration 2-a-2 (Only Diet) Structural Model Evaluation"
...
```
R² for the lower-order construct Perceived Self-Efficacy is below the critical threshold of 0.1.
...
oospp <- (as.data.frame(sumplspre$PLS_out_of_sample) %>%
  ...
  cbind(`Prediction Errors` = c("PLS RMSE", "PLS MAD", "LM RMSE", "LM MAD", "RMSE Difference", "MAD Difference")))[c(1,3,5,2,4,6),c(10,1:9)]
datatable(oospp,
...
```
As already hinted by a lack of effect size, neither Threat Beliefs nor Personal Moral Norm or Subjective Norm show a significant influence on Behavioral Intention as indicated by the path coefficients.
