---
title: "Climate Crisis Model Iteration 2-a-2 Structural Model Evaluation"
...
The effect of Knowledge on Response Beliefs is also negligible.
...
```
Again, only for Behavioral Intention does the model show some out-of-sample predictive power.
...
Because of the lack of effect associated with many of the lower-order constructs, splitting up all higher-order constructs and reducing the model from there might lead to better predictive power.
