---
title: "Climate Crisis Model Iteration 2-c (Driving) Measurement Model Evaluation"
...
radn <- readRDS("Models/radn-cc-2-c-1.RDS")
rain <- readRDS("Models/rain-cc-2-c-1.RDS")
...
Three weights are insignificant on the basis of the bootstrap CI and/or t-value (CCDN1, CCIN1, and CCIN2), however, the loadings are large enough and significant.
...
The weight for Integrity and Injunctive Norm are not significant, but the loadings are sufficiently large and significant.
