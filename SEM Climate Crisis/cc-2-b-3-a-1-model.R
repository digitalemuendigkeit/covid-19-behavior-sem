...
# Threat Beliefs and Descriptive Norm can be eliminated as constructs, but Injunctive Norm should be retained.
...
# Version Response Beliefs as HOC
...
sm <- relationships(
  ...
  paths(from = c("Response Beliefs", "Personal Moral Norm", "Injunctive Norm"), to = "Behavioral Intention")
)
...
saveRDS(rain, "SEM Climate Crisis/Models/rain-cc-2-b-3-a.RDS")
