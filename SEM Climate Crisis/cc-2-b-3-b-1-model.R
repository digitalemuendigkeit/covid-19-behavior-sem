...
sm <- relationships(
  paths(from = c("Distrusting Beliefs Benevolence", "Knowledge"), to = c("Perceived Self-Efficacy", "Perceived Response Efficacy", "Perceived Response Costs")),
  paths(from = c("Perceived Self-Efficacy", "Perceived Response Efficacy", "Perceived Response Costs", "Personal Moral Norm"), to = "Behavioral Intention")
)
