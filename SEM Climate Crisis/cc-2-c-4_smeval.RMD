---
title: "Climate Crisis Model Iteration 2-c-4 (Driving) Structural Model Evaluation"
...
```
R² for Perceived Response Costs and Perceived Self-Efficacy is below the critical threshold of 0.1.
Other than that, the R² for Perceived Response Efficacy is between 0.1 and 0.25, indicating very weak in-sample predictive power.
...
```
For the approximation model, only CBI3 is predicted better by the PLS model than by the linear model in terms of both RMSE and MAD.
...
There does not seem to be any discernible difference compared to the model with the Response Beliefs as a higher-order constructs.
