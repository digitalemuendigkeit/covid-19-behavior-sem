...
Competence only has an effect on Perceived Severity, and  Benevolence on Perceived Susceptibility and Perceived Severity.
...
Among the (higher-order) constructs, there is no effect of Knowledge on Response Beliefs, or of Threat Beliefs or Subjective Norm on Behavioral Intention.
...
For the approximation model, the PLS model predicts CCIBI2 better than the naive linear model.
...
None of the paths from Integrity is significant, and for Competence only the paths to the Threat Beliefs lower-order constructs are.
For Benevolence, all paths are significant.
Concerning the Response and Threat Beliefs lower-order constructs, only Perceived Self-Efficacy has a significant path to Behavioral Intention.
...
The paths from Threat Beliefs and Subjective (as well as Descriptive) Norm to Behavioral Intention are insignificant.
However, the path from Injunctive Norm is significant.
...
# Results summary
The path from Knowledge to Response Beliefs is insignificant and shows no effect, as are the paths from Threat Beliefs and Subjective Norm in Behavioral Intention.
