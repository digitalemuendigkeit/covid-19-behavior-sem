...
```
The effects of Perceived Response Efficacy and Perceived Response Costs are negligible.
...
```
With the exception of the path from Perceived Response Costs on Behavioral Intention, all paths are significant.
