---
title: "Climate Crisis Model Iteration 2-a-4-b-1 Structural Model Evaluation"
...
bootfsmodel <- bootmodel
proxymodel <- estimate_pls(data = as.data.frame(model$data), structural_model = model$smMatrix, measurement_model = model$measurement_model)
summo <- summary(model)
...
There is no discernible effect of Knowledge on either Perceived Self-Efficacy.

# Out-of-sample predictive power
Out of sample predictive power can be evaluated on the original model as there are no HOCs.
...
# Results summary
Overall, the model is satisfactory, but in-sample as well as out-sample predictive power is low and effect sizes, with the exception of the effect of Distrusting Beliefs Integrity on Perceived Response Efficacy and the effect of Perceived Self-Efficacy on Behavioral Intention, are as well.
