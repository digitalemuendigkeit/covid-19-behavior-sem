---
title: "Climate Crisis Model Iteration 2-a (Only Diet) Structural Model Evaluation"
...
model <- readRDS("Models/model-cc-2-a.RDS")
bootmodel <- readRDS("Models/model-boot-cc-2-a.RDS")
bootfsmodel <- readRDS("Models/model-fs-boot-cc-2-a.RDS")
proxymodel <- readRDS("Models/model-proxy-cc-2-a.RDS")
summo <- summary(model)
...
```
As already hinted by a lack of effect size, neither Threat Beliefs nor Personal Moral Norm or Subjective Norm shows a significant influence on Behavioral Intention as indicated by the path coefficients.
