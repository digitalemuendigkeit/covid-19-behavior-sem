...
# saveRDS(model, "SEM Climate Crisis/Models/model-cc-2-b-3-b-2.RDS")
model <- readRDS("SEM Climate Crisis/Models/model-cc-2-b-3-b-2.RDS")
plot(model)
# bootmodel <- bootstrap_model(model, nboot = 5000)
# saveRDS(bootmodel, "SEM Climate Crisis/Models/model-boot-cc-2-b-3-b-2.RDS")
bootmodel <- read_rds("SEM Climate Crisis/Models/model-boot-cc-2-b-3-b-2.RDS")
plot(bootmodel)
