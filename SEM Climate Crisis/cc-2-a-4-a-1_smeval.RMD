---
title: "Climate Crisis Model Iteration 2-a-4-a-1 Structural Model Evaluation"
...
Knowledge has no discernible effect on Perceived Self-Efficacy.
All other effect sizes are at least small.
...
# Results summary
Overall, the model is satisfactory, but in-sample predictive power is low and the model lacks out-of-sample predictive power. 
Effect sizes, with the exception of the effect of Response Beliefs on Behavioral Intention, are small to negligible.
