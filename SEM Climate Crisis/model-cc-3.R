...
#saveRDS(model, "SEM Climate Crisis/Models/model-cc-3.RDS")
model <- readRDS("SEM Climate Crisis/Models/model-cc-3.RDS")
plot(model)
# bootmodel <- bootstrap_model(model, nboot = 5000)
# saveRDS(bootmodel, "SEM Climate Crisis/Models/model-boot-cc-3.RDS")
bootmodel <- read_rds("SEM Climate Crisis/Models/model-boot-cc-3.RDS")
plot(bootmodel)
...
# saveRDS(rapse, "SEM Climate Crisis/Models/rapse-cc-3.RDS")
#
...
# saveRDS(rapre, "SEM Climate Crisis/Models/rapre-cc-3.RDS")
#
...
# saveRDS(raprc, "SEM Climate Crisis/Models/raprc-cc-3.RDS")
...
saveRDS(radn, "SEM Climate Crisis/Models/radn-cc-3.RDS")
...
saveRDS(rain, "SEM Climate Crisis/Models/rain-cc-3.RDS")
...
# saveRDS(rabi, "SEM Climate Crisis/Models/rabi-cc-3.RDS")
