...
Neither do Perceived Response Costs or Injunctive Norm on Behavioral Intention.
...
```
The path coefficients from Knowledge to Perceived Response Efficacy is insignificant.
So are the coefficients for the path from Perceived Response Efficacy and Injunctive Norm to Behavioral Intention.
...
# Results summary
The paths from Knowledge to Perceived Response Efficacy, as well as from Perceived Response Efficacy and Injunctive Norm to Behavioral Intention are insignificant and show no effect.
The path from Knowledge to Perceived Self-Efficacy has a negligible effect, but a significant path coefficient.
