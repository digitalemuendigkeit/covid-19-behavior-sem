...
So has Perceived Response Efficacy on Behavioral Intention.
...
# Results summary
Effect sizes and model predictiveness are overall weak, but on the basis of path coefficients significance, this model can stay as-is.
