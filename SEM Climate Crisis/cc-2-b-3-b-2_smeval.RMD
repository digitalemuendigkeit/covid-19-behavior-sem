---
title: "Climate Crisis Model Iteration 2-b-3-b-2 (Only Heating) Structural Model Evaluation"
...
```
For Perceived Self-Efficacy the model predictiveness is very weak.
...
```
Knowledge has only a negligible effect on Perceived Self-Efficacy.
...
Overall, the model has medium out-of-sample predictive power.
...
# Results summary
Effect sizes and model predictiveness is overall weak, but on the basis of path coefficients significance, this model can stay as-is.
