---
title: "Climate Crisis Model Iteration 2-a-3-a-1 Structural Model Evaluation"
...
Specifically, there is no discernible effect of Benevolence.
The effect of Knowledge on Response Beliefs and its lower-order costructs is also negligible.
...
```
The model does not have out-of-sample predictive power.
...
Concerning paths with lower-order constructs, Knowledge has no significant path to Perceived Self-Efficacy.
Benevolence has no significant path to Perceived Self-Efficacy.
