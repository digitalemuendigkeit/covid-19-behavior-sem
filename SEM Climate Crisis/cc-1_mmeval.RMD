...
Convergent validity is insufficient for Perceived Self-Efficacy, Perceived Response Efficacy, Perceived Response Costs and Behavioral Intention. There were no issues with collinearity as indicated by the VIF. Concerning significance and relevance, the weight for CCRB8 was very small and non-significant, and the loading was below 0.5. Therefore, CCRB8 should be discarded.
For CCIN1, the weight was also insignificant (0 in the bootstrapping CI), but the loading was large and significant.
To remedy the problems with convergent validity, we looked at the correlations of the indicators with the redundant reflective measure.
...
```
For Perceived Self-Efficacy, CCRB3 has the lowest correlation with the reflective measure (r = 0.386) and should be discarded. For Perceived Response Efficacy, CCRB6 (r = 0.523) will be discarded. For Perceived Response Costs, CCRB8 (r = 0.349) should be discarded on the basis of convergent validity, as well as significance and relevance. For Behavioral Intention, CCBI1 (r = 0.398) should be discarded.

To sum up, CCRB3, CCRB6, CCRB8 and CCBI1 should be discarded
