---
title: "Climate Crisis Model 3b Measurement Evaluation"
...
radn <- readRDS("Models/radn-cc-3b.RDS")
rain <- readRDS("Models/rain-cc-3b.RDS")
...
All multi-item indicators and constructs show sufficient convergent validity, internal consistency reliability and discriminant validity.
...
There are no issues with collinearity as measured with VIF, and all indicators are relevant. Only the CCDN1 indicator weight is significant, but all other indicators have significant and sufficiently large loadings.
...
For the formative higher-order constructs, there are no issues with collinearity (VIF above 3 for some but below 5) and all weights are significant and relevant. The formative higher-order constructs can be retained as hypothesized.

# Results summary
Overall, all measurement models and higher-order constructs meet the quality criteria. Structural model evaluation can follow.
