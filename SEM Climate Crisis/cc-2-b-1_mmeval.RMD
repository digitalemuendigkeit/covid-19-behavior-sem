...
The weights for Injunctive Norm and Distrusting Beliefs Integrity are not significant, but the loadings are sufficiently large and significant.
On the other hand, the weight for Perceived Response Costs is nonsignificant, and the loading is too small. Therefore it has to be discarded.
