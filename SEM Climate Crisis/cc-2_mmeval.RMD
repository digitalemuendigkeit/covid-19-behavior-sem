...
What should happen to remedy this?
...
# Results summary
The reflective measurement model and the formative higher-order constructs meet all quality criteria. With the formative measurement model, there are substantial problems with convergent validity. One way to remedy this would be to substitute the problematic formative constructs by the single-item reflective constructs used in the redundancy analysis. Alternatively, the single indicators should refer to the respective measure that shows the highest intercorrelation with the single-indicator reflective constructs, overall. CCPN2 can also be removed in order to reduce the potential for erroneous estimating.
