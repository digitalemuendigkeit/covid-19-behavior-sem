...
colnames(forevalmm)[13] <- paste0("t(", nrow(model$data), ") (loading)")
```
...
datatable(forevalmm,
  ...
  formatStyle('VIF', backgroundColor = styleInterval(cuts = c(5), values = c('#00', '#ff9999'))) %>%
  formatStyle('Weight (original estimate)', backgroundColor = styleInterval(cuts = c(0), values = c('#ff9999', '#00'))) %>%
  formatStyle('Weight (bootstrap mean)', backgroundColor = styleInterval(cuts = c(0), values = c('#ff9999', '#00'))) %>%
  formatStyle(colnames(forevalmm)[8], backgroundColor = styleInterval(cuts = c(1.65), values = c('#ff9999', '#00'))) %>%
  ...
  formatStyle(colnames(forevalmm)[8], backgroundColor = styleInterval(cuts = c(1.65), values = c('#ff9999', '#00'))) %>%
  formatStyle('0 in CI (weight)', backgroundColor = styleEqual(c(1,0), c('#ff9999', '#00'), default = NULL)) %>%
...
datatable(forhocevalmm,
  ...
  formatStyle('Weight (original estimate)', backgroundColor = styleInterval(cuts = c(0), values = c('#ff9999', '#00'))) %>%
  formatStyle('Weight (bootstrap mean)', backgroundColor = styleInterval(cuts = c(0), values = c('#ff9999', '#00'))) %>%
  formatStyle(colnames(forhocevalmm)[6], backgroundColor = styleInterval(cuts = c(1.65), values = c('#ff9999', '#00'))) %>%
  formatStyle('Loading (original estimate)', backgroundColor = styleInterval(cuts = c(0.5), values = c('#ff9999', '#00'))) %>%
  formatStyle('Loading (bootstrap mean)', backgroundColor = styleInterval(cuts = c(0.5), values = c('#ff9999', '#00'))) %>%
