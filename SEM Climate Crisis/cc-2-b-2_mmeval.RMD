---
title: "Climate Crisis Model Iteration 2-b-2 (Only Heating) Measurement Model Evaluation"
...
radn <- readRDS("Models/radn-cc-2-b-2.RDS")
rain <- readRDS("Models/rain-cc-2-b-2.RDS")
...
Three weights are insignificant on the basis of the bootstrap CI or t-value (CCDN1, CCIN1, CCIN2), however, the loadings are large enough and significant.
...
The weights for Distrusting Beliefs Integrity and Injunctive Norm are non-significant, but the loadings are significant and sufficiently large.
...
# Results summary
All measurement models meet quality criteria. Structural Model evaluation can commence.
